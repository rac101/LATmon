...
# usage: ./addup.pl < tup.out
# usage: ./addup.pl < tup.int
...
$jd200806 = julian_day(2008,6,25); # julian day for 25 June 2008 (date of first LAT data run)
$jd2008 = julian_day(2008,8,4); # julian day for 4 August 2008 (start of LAT science mission)
$today = `date +%F`;
chomp $today;
$s1970 = `date +%s`;
$jdnow = local_julian_day($s1970);
$mission_days06 = $jdnow - $jd200806;
$mission_days = $jdnow - $jd2008;
$misec06 = $mission_days06*86400;
$misec = $mission_days*86400;
print "Today is $today\n";
print $mission_days06, " days from 2008 June 25 to $today = $misec06 mission seconds\n";
print $mission_days, " days from 2008 August 4 to $today = $misec mission seconds\n\n";
