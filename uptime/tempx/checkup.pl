...
#    $dt = $f[4];
    ...
    if (abs($f[4] - $ttot1) > 100) { print "$0: tot time $f[4] <> sum1 $ttot1 at $f[0] $f[1]\n" };
    if (abs($f[4] - $ttot2) > 100) { print "$0: tot time $f[4] <> sum2 $ttot2 at $f[0] $f[1]\n" };
