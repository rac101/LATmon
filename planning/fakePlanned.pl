...
$t0 = formtime($time);
$lines{$time} = "$t0,$t0,ATSList,NORMAL,InReview,Unknown,[$mpmw] LATSUROMDUMP RTS (MPLAN-679)\n";

# the following output ATSList lines are obsolete, replaced by the LATSUROMDUMP RTS
