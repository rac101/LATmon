...
# also report error counts inside and outside SAA
...
print "Number of errors with SAA flags = $SAA\n";
$SAA = $SAAin + $SAAout;
print "Number of errors inside SAA, outside SAA and inside+outside = $SAAin $SAAout $SAA\n";
print 100*$SAAin/$SAA," Percent of errors inside SAA\n";
